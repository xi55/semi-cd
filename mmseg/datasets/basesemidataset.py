...
class BaseSemiDataset(BaseDataset):
    ...
    Args:
        ...
        data_prefix (dict, optional): Prefix for training data. Defaults to
            dict(img_seg=None, seg_map_path=None).
    ...
    def __init__(self,
                 ...
                 data_prefix: dict = dict(img_seg='', seg_map_path=''),
    ...
    def load_data_list(self) -> List[dict]:
        ...
        """
        data_list = []
        img_dir = self.data_prefix.get('img_seg', None)
        ann_dir = self.data_prefix.get('img_seg_label', None)
        ...
        if not osp.isdir(self.ann_file) and self.ann_file:
            ...
            for line in lines:
                img_name = line.strip()
                data_info = dict(
                    img_seg=osp.join(img_dir, img_name + self.img_suffix))
            ...
            for img in fileio.list_dir_or_file(
                ...
                data_info = dict(img_seg=osp.join(img_dir, img))
                if ann_dir is not None:
                ...
                data_info['seg_fields'] = []
                data_list.append(data_info)
            data_list = sorted(data_list, key=lambda x: x['img_seg'])
        return data_list
