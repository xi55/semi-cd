...
class SemiImgResizeToMultiple(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgRerange(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgCLAHE(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgRandomCrop(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgRandomRotate(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgRGB2Gray(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgAdjustGamma(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgPhotoMetricDistortion(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgRandomCutOut(BaseTransform):
    """CutOut operation.
...
@TRANSFORMS.register_module()
class SemiImgRandomRotFlip(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgResizeShortestEdge(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgExchangeTime(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgResize(BaseTransform):
    """Resize images & seg.
...
@TRANSFORMS.register_module()
class SemiImgRandomResize(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgNormalize(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgRandomFlip(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgPad(BaseTransform):
...
@TRANSFORMS.register_module()
class SemiImgAlbu(BaseTransform):
