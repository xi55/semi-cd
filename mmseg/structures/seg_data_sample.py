...
class SegDataSample(BaseDataElement):
    ...
    @property
    def label_seg_map(self) -> PixelData:
        return self._label_seg_map
    
    @label_seg_map.setter
    def label_seg_map(self, value: PixelData) -> None:
        self.set_field(value, '_label_seg_map', dtype=PixelData)

    @label_seg_map.deleter
    def label_seg_map(self) -> None:
        del self._label_seg_map
